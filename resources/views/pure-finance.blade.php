    ...
    <div x-data="{
        ...
        <div class="p-4">
            <div class="flex items-center justify-between">
                ...
                <div x-cloak class="justify-center hidden sm:flex">
                    <div
                        ...
                        <div class="flex">
                            <template x-for="(tab, index) in tabs" :key="index">
                                <button x-on:click="activeTab = tab"
                                    ...
                                    :class="activeTab === tab ?
                                        'text-slate-800 dark:text-white bg-white dark:bg-slate-700 shadow' :
                                        ''">
        ...
        <div
            class="fixed bottom-0 flex items-center justify-between w-full px-4 py-1.5 bg-white border-t shadow-sm sm:hidden border-slate-200 dark:border-slate-600 dark:bg-slate-800">
            <button class="flex flex-col items-center w-1/2" :class="activeTab === 'accounts' ? 'text-indigo-500' : ''"
                x-on:click="activeTab = 'accounts'">
            ...
            <button class="flex flex-col items-center w-1/2"
                :class="activeTab === 'transactions' ? 'text-indigo-500' : ''" x-on:click="activeTab = 'transactions'">
