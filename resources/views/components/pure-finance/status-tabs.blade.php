        ...
        <div class="flex">
            <template x-for="(tab, index) in tabs" :key="index">
                <button x-on:click="$wire.set('status', tab)"
                    class="py-0.5 px-2.5 text-sm font-medium transition rounded-md text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-100 focus:outline-none duration-200 ease-in-out flex items-center text-center justify-center"
