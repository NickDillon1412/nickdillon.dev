<div x-data="{
    ...
    <div class="relative inline-flex w-full">
        <div class="flex items-stretch w-full mt-2">
            <div
                class="flex items-center w-full text-sm text-left rounded-lg ring-1 shadow-sm border-slate-300 dark:border-slate-700 dark:bg-slate-900 form-input py-[9px] dark:text-slate-300 z-20"
