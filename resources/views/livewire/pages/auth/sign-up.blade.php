            ...
            <div class="mt-4">
                ...
                <div class="relative pt-0.5">
                    ...
                    <button x-cloak x-on:click="showPassword = !showPassword" class="absolute inset-y-0 top-0 flex items-center end-4" type="button">
                        <flux:icon x-show="!showPassword && $wire.password.length" icon="eye" variant="outline" class="w-5 h-5" />

                        <flux:icon x-show="showPassword && $wire.password.length" icon="eye-slash" variant="outline" class="w-5 h-5" />
                    </button>
                </div>
            ...
            <div class="mt-4">
                ...
                <div class="relative pt-0.5">
                    ...
                    <button x-cloak x-on:click="showPasswordConfirmation = !showPasswordConfirmation" class="absolute inset-y-0 top-0 flex items-center end-4" type="button">
                        <flux:icon x-show="!showPasswordConfirmation && $wire.password_confirmation.length" icon="eye" variant="outline" class="w-5 h-5" />

                        <flux:icon x-show="showPasswordConfirmation && $wire.password_confirmation.length" icon="eye-slash" variant="outline" class="w-5 h-5" />
                    </button>
                </div>
