<div x-data="{ plannedSpendingFormModalOpen: false }" x-init="console.log(Intl.DateTimeFormat().resolvedOptions().timeZone)" x-on:planned-expense-saved.window="$wire.$refresh"
    ...
    <div class="flex flex-col space-y-3">
        ...
        <div
            ...
            <div class="flex flex-col border-t border-slate-200 dark:border-slate-600">
                    ...
                    <div>
                        ...
                        <div class="w-full my-1.5 h-9 bg-indigo-100 dark:bg-slate-700 shadow-sm rounded-lg">
                            <div @class([
                                ...
                                <span x-cloak x-show="$wire.percentage_spent > 0" class="font-semibold text-white">
