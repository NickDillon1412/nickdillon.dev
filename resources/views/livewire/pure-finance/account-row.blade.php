<tr>
    ...
    <td class="pr-3 py-2.5 text-sm font-medium whitespace-nowrap text-end">
        <a class="text-sm flex justify-end font-medium text-indigo-500"
            href="{{ route('pure-finance.account.overview', $account) }}" wire:navigate>
            <div class="flex items-center -mr-0.5 px-2 py-1 duration-200 ease-in-out hover:bg-slate-200 dark:hover:bg-slate-700 rounded-md justify-end">
                <span>View</span>
