<div class="w-full p-4 mx-auto overflow-y-hidden sm:py-8 sm:px-6 lg:px-8 max-w-screen-2xl">
    <div class="flex flex-col space-y-3">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <flux:button x-on:click="$dispatch('open-tag-create-form')" variant="indigo" icon="plus" size="sm"
                            ...
                            <tr wire:key='{{ $tag->id }}'>
                                ...
                                <td
                                    ...
                                    <div class="flex items-center justify-end">
                                        <button
                                            x-on:click="$dispatch('open-tag-edit-form', { tag: {{ $tag->toJson() }} })">
