    ...
    <div
        ...
        <div class="flex items-center justify-between px-5 py-4">
            ...
            <div class="relative w-40 -my-2 sm:w-64">
                ...
                <input type="text" wire:model.live.debounce.300ms='search' name="hs-table-search" id="hs-table-search"
                    class="block w-full px-3 text-sm rounded-lg shadow-sm border-slate-200 ps-9 focus:z-10 focus:border-indigo-500 focus:ring-indigo-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-slate-700 dark:text-slate-400 dark:placeholder-slate-500 dark:focus:ring-indigo-600"
                    placeholder="Search..." />
