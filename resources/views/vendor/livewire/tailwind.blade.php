            ...
            <div class="flex justify-between flex-1 sm:hidden">
                <span>
                    @if ($paginator->onFirstPage())
                        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium leading-5 bg-white border rounded-md cursor-default text-slate-500 border-slate-200 dark:bg-slate-800 dark:border-slate-600 dark:focus:border-blue-700 dark:active:bg-slate-700 dark:active:text-slate-300">
