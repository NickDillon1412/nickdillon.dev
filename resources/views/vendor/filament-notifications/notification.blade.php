...
<x-filament-notifications::notification :notification="$notification" :x-transition:enter-start="
    ...
    " @class([
        ...
        ...match ($isInline) {
            ...
            false => [
                ...
                match ($color) {
                    ...
                    default
                        => 'fi-color-custom ring-custom-600/20 dark:ring-custom-400/30',
                },
        ...
        \Filament\Support\get_color_css_variables($color, shades: [50, 400, 600], alias: 'notifications::notification') => !($isInline || $color === 'slate'),
    ])>
    <div @class([
        'flex w-full gap-3 py-3 px-4',
        match ($color) {
            'slate' => null,
        ...
        <div class="mt-0.5 grid flex-1">
            ...
            @if ($hasBody)
                <x-filament-notifications::body @class(['mt-1' => $hasTitle || $hasDate])>
